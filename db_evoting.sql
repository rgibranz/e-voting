...
INSERT INTO `tb_admin` (`id_admin`, `username`, `password`, `id_jurusan`, `level`) VALUES
...
CREATE TABLE `tb_calon` (
  ...
  `jurusan_calon_presma` varchar(128) NOT NULL,
  `jurusan_calon_wapresma` varchar(128) NOT NULL,
...
INSERT INTO `tb_calon` (`id_calon`, `jurusan_calon_presma`, `jurusan_calon_wapresma`, `nim_calon_presma`, `nim_calon_wapresma`, `calon_presma`, `calon_wakil_presma`, `visi_misi`, `gambar`, `video`) VALUES
...
INSERT INTO `tb_pemilih` (`id_pemilih`, `id_jurusan`, `nim`, `nama`, `email`, `password`) VALUES
